<?php
/**
 * Operations and common functions of PWA
 *
 * @since 1.0
 *
 ...
 *
 * 1. Check if site is PWA ready
 * 2. Check if setting is enabled in admin
 * 3. Filter the result
 *
 * @since 1.9.6
 *
 ...
 * @since 1.7 Added filter superpwa_manifest_start_url when $rel = true, for use with manifest. First ever filter in PWA.
 */
